...
export const COCA_COLA: Sticker[] = [
  ...
  { id: 'CC7', name: 'Jéfferson Lerma - Colombia' },
  { id: 'CC8', name: 'Enner Valencia - Ecuador' },
  { id: 'CC9', name: 'Gabriel Magalhães - Brasil' },
  { id: 'CC10', name: 'Virgil van Dijk - Países Bajos' },
  { id: 'CC11', name: 'Alphonso Davies - Canadá' },
  { id: 'CC12', name: 'Emiliano Martínez - Argentina' },
  { id: 'CC13', name: 'Raúl Jiménez - México' },
  { id: 'CC14', name: 'Lautaro Martínez - Argentina' },
];
